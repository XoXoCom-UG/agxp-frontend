    ...
    <div className="app" style={{ height: "auto", overflowY: "auto" }}>
      <div className="view-root view-enter" style={{ display: "block", flex: "none" }}>
        ...
        <main className="workspace" style={{ height: 700 }}>
          <ProjectChatPanel project={mockProject} role="consultant" agent={consultant} grow={2.3} />
          <ProjectChatPanel project={mockProject} role="coach" agent={coach} grow={1} />
        </main>
        ...
        <main className="workspace" style={{ height: 640 }}>
          <AgentPickerPanel role="consultant" project={null} agents={pickerAgents} grow={2.3}
            ensureProject={async () => mockProject}
            onAssigned={() => {}}
            onAgentCreated={a => setPickerAgents(prev => [...prev, a])} />
          <AgentPickerPanel role="coach" project={null} agents={pickerAgents} grow={1}
            ensureProject={async () => mockProject}
            onAssigned={() => {}}
            onAgentCreated={a => setPickerAgents(prev => [...prev, a])} />
        </main>
